    ...
    try {
      ...
      if (response && response.success) {
        ...
        Alert.alert(
          "Erreur",
          response.error
            ? `Erreur lors de la soumission de l'incident: ${response.error.message}`
            : "Une erreur est survenue lors de la soumission de l'incident."
        );
      }
    } catch (error) {
        ...
        { loadingLocation ? (
          ...
          <View style={styles.zoneContainer}>
            ...
            <View style={{ flexDirection: 'column' }}>
              ...
              <Text style={styles.zone}>{currentReport.zone}</Text>
            </View>
